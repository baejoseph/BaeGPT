...
st.write("A custom GPT built on OpenAI’s GPT-4o. :brain:")
st.write("All fine-tuning by Joseph Bae 배홍철 © 2023-2024. Made for my children and 사랑하는 조카들, 예닮이 & 예일이 :smile:")
